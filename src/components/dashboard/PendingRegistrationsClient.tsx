...
export default function PendingRegistrationsClient({ eventId }: { eventId: string }) {
  ...
  useEffect(() => {
    if (status === 'unauthenticated') {
      router.push(`/auth/signin?callbackUrl=/organizer/dashboard/events/${eventId}/pending`);
